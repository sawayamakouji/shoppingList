  ...
  const quizData = [
    {
      ...
      correctAnswer: '2m',
      explanation:
        '1m, 2m, 3mの形は両面待ちになっていますが、既に1mが2枚あるため、2mを切って1m, 3mの嵌張待ちにするより、2mを残して1m, 2m, 3mの形を保った方が良いです。また、2p, 3p, 4pと6s, 7s, 8sは完成した面子なので切るべきではありません。',
    },
    {
      id: 2,
      ...
      correctAnswer: '1z',
      explanation:
        '手牌には既に2つの完成した面子（2m, 3m, 4mと2p, 3p, 4p）と、雀頭候補（5p, 5p）があります。また、5s, 6s, 7sは良形の塔子です。1zは役に繋がりにくい孤立牌なので切るのが最適です。',
    },
    {
      id: 3,
      ...
      correctAnswer: '2p',
      explanation:
        '1m〜6mは一気通貫の可能性を持つ良形です。7s, 8s, 9sと9s, 9s, 9sは完成した面子です。2p, 3pは孤立した塔子で、しかも2pと3pの間には他の牌との連携がないため、2pか3pを切るべきです。2pの方が壁になっている可能性が高いので2pを切ります。',
    },
    {
      id: 4,
      ...
      correctAnswer: '7z',
      explanation:
        '手牌には既に一つの刻子（1m, 1m, 1m）と索子の2s〜9sまでがあり、一気通貫や清一色の可能性があります。6z（發）と7z（中）は役牌になる可能性がありますが、7z単独よりも6zの方が發と組み合わせて役牌になる可能性が高いため、7zを切ります。',
    },
    {
      id: 5,
      ...
      correctAnswer: '6s',
      explanation:
        '筒子（p）で多くの良形が揃っています。3p, 4p, 5pと5p, 6p, 7pの面子、さらに5p, 5p, 5pの刻子があります。また、2m, 3m, 4mも完成面子です。6s, 7sは孤立した塔子なので、どちらかを切るべきです。筒子の手を活かすなら、索子は切った方が良いでしょう。',
    },
    {
      id: 6,
      ...
      correctAnswer: '4z',
      explanation:
        '三色同順の形（1m, 2m, 3m、1p, 2p, 3p、1s, 2s, 3s）が完成しています。残りは4z, 4z（北）と5z, 5z（白）で、どちらかを雀頭にすることになります。北は役にならないことが多いですが、白は役牌になるため、白を残して北を切るのが良いでしょう。',
    },
    {
      id: 7,
      ...
      correctAnswer: '9s',
      explanation:
        '手牌には3つの完成面子（2m, 3m, 4m、7m, 8m, 9m、2p, 3p, 4p）があります。6s, 7s, 8s, 9sの中から1枚切る必要がありますが、6s, 7s, 8sは両面待ちの可能性がある良形なので、9sを切るのが最適です。',
    },
    {
      id: 8,
      ...
      correctAnswer: '7z',
      explanation:
        '1m〜8mまでの良形があり、清一色や一気通貫の可能性があります。3p, 4p, 5pも完成した面子ですが、7z, 7z（中）は他の牌と組み合わせて役を作る可能性が低いです。清一色や一気通貫を目指すなら、字牌の7zを切るのが良いでしょう。ただし、既に雀頭として使える7z, 7zがあるため、もう一つの選択肢としては筒子の面子を切る選択肢もあります。',
    },
    {
      id: 9,
      ...
      correctAnswer: '6z',
      explanation:
        '萬子で清一色に近い形になっています。1m, 1m, 1mの刻子と、2m〜7mの連続した塔子があります。2s, 3s, 4sは完成した面子ですが、6z（發）は孤立牌です。清一色を目指すなら索子の面子を切るべきですが、既に完成しているため、孤立している6zを切る方が良いでしょう。',
    },
    {
      id: 10,
      ...
      correctAnswer: '1z',
      explanation:
        '三色同順（2m, 3m, 4m、4p, 5p, 6p、4s, 5s, 6s）が完成しており、1z, 1z（東）と7z, 7z（中）の2つの雀頭候補があります。中は三元牌で役牌になりますが、東は自風牌でない限り役にはなりません。そのため、東を切るのが最適です。',
    },
  ];
    ...
    <div className="p-4">
      ...
      {showResults ? (
        ...
        <div>
          ...
          {isAnswered && (
            <div className="mb-4">
              <p>{selectedOption === currentQuestion.correctAnswer ? '正解っす！' : '不正解っす！'}</p>
