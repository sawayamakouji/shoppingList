  ...
  const quizData = [
    {
      ...
      correctAnswer: ['1m', '2m'],
      explanation:
        '1mを切れば2m3mの両面待ちを残せます。2mを切っても嵌張待ちの可能性が残りますが、一般的にはリャンメン待ちを優先するため1m切りが最善です。',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: ['2p', '7s'],
      explanation:
        '2p,3pは孤立した塔子ですが、7sは役が狙いづらい孤立面子です。どちらも有効で、2p切りは萬子の一気通貫狙い、7s切りはピンズの伸び重視です。',
    },
